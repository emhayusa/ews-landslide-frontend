...
function initLayer() {
  ...
  layerRef.value = new TileLayer({
    source: new XYZ({
      ...
      attributions: 'BMKG ECMWF Rain © BMKG',
      crossOrigin: "Anonymous"
    }),
    visible: props.visible,
    opacity: 0.5,
    zIndex: 11 // Agar letaknya di atas basemap, namun di bawah layar interaktif / angin
  })
...
<template>
  <div class="rain-layer-container" style="display: none;"></div>
</template>
