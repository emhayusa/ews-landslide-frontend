...
function initLayer() {
  ...
  layerRef.value = new TileLayer({
    source: new XYZ({
      url: "https://signature.bmkg.go.id/api21/mpl_req/ecmwf/rh/1000/2026041012/2026041100/{z}/{x}/{-y}.png?ci=1&overlays=contourf",
      attributions: 'BMKG ECMWF Humidity © BMKG',
...
<template>
  <div class="humidity-layer-container" style="display: none;"></div>
</template>
