...
<template>
    <q-card flat bordered class="absolute-top-left q-ma-md" :style="{
        width: '200px',
        height: '55px',
        marginLeft: '600px',
            ...
            <q-input ref="filterAnchor" dense :model-value="inputLabel" class="full-width">
                ...
                <q-menu anchor="bottom left" self="top left" :offset="[8, 15]" style="width: 270px">
                    <q-card flat>
                        <q-card-section>
                            <!-- Search -->
                            <q-input v-model="search" dense outlined placeholder="Cari kabupaten..." class="q-mb-md"
                                debounce="300">
                                <template #prepend>
                                    <q-icon name="search" />
                                </template>
